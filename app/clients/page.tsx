...
import { ChevronLeft, Mail, Phone, MapPin, FileText, Edit, Trash2 } from "lucide-react";
import { Button } from "@/components/ui/button";
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card";
import { Client, InsurancePolicy, getPoliciesByClient, mockClients, mockPolicies } from "@/lib/insurance-data";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
export default function ClientsPage() {
  ...
  const handleDeleteClient = (clientId: string) => {
    ...
    localStorage.setItem("clients", JSON.stringify(clients.filter((c) => c.id !== clientId)));
  };
